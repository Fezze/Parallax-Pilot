...
AppSettingsPage({
  build(props) {
    ...
    const playerId = storage.getItem(LEADERBOARD_STORAGE_KEYS.PLAYER_ID) || 'demo-player'
    ...
    return Section({ style: { padding: '20px 16px 32px', background: '#0b0d11', color: '#ffffff', minHeight: '100%', fontFamily: 'ui-sans-serif, system-ui, sans-serif' } }, [
      ...
      Text({ text: `${t(locale, 'player')}: ${playerId}`, style: { fontSize: '14px', color: '#ffffff', marginBottom: '6px' } }),
